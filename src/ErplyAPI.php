...
class ErplyAPI
{
    ...
    public function getSalesDocumentsBulk(array $parameters = [[]])
    {
        $bulkParameters = [];
        foreach ($parameters as $parameter) {
            array_push($bulkParameters, array_merge(['requestName' => 'getSalesDocuments'], $parameter));
        }
    ...
    public function addCustomerRewardPoints(array $parameters = [])
    {
        $parameters = array_merge($parameters, ['request' => 'addCustomerRewardPoints']);
    ...
    public function getCashIns(array $parameters = [])
    {
        $parameters = array_merge($parameters, ['request' => 'getCashIns']);
